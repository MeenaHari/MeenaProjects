...
public class XeroReUsableMethod1 extends XeroAutomationScriptsDriver1{
	...
	public static void enterText1(WebElement webObj, String objName){
		if(webObj.isDisplayed()){
			//webObj.sendKeys(textVal);
			System.out.println("Pass: " + objName+" field exists");
		}else{
